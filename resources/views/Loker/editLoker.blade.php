        ...
        <div class="flex flex-col md:flex-row pb-4 mb-4">
                ...
                <div>
                    <div class="flex flex-col md:flex-row w-max">
                        <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                            <input type="text" class="p-1 px-2 w-96" name="posisi" value="{{ old('posisi', $loker->posisi) }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                <div class="w-44 font-bold h-6 mx-2 mt-3">Job Description</div>
                <div>
                    <div class="flex flex-col md:flex-row w-max">
                        <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                            <input type="text" class="p-1 px-2 py-10 w-96" name="jobdesc" value="{{ old('jobdesc', $loker->jobdesc) }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                <div class="w-44 font-bold h-6 mx-2 mt-3">Kriteria</div>
                <div>
                    <div class="flex flex-col md:flex-row w-max">
                        <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                            <input type="text" class="p-1 px-2 w-96" name="kriteria" value="{{ old('kriteria', $loker->kriteria) }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                ...
                <div>
                    <div class="flex flex-col md:flex-row w-max">
                        <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                            <input type="text" class="p-1 px-2 w-96" name="domisili" value="{{ old('domisili', $loker->domisili) }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row pb-4 mb-4">
                <div class="w-44 font-bold h-6 mx-2 mt-3">Link Pendaftaran</div>
                <div>
                    <div class="flex flex-col md:flex-row w-max">
                        <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
