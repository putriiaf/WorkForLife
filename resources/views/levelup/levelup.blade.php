...
@section('content')
<div
    class="relative pt-10 md:mt-0 md:h-screen flex flex-col justify-center text-center md:text-left md:flex-row md:justify-between md:items-center lg:px-20 md:px-12 px-4">
    <div class="md:flex-1 md:mr-40">
        ...
        <div>
            <form class="font-montserrat flex">
                <a href="#"
                    class="px-8 rounded-lg bg-[#E84A5F]  text-white font-bold p-4  border-[#E84A5F] hover:bg-[#E84A5F]/75 border-[#E84A5F]/75">Cek
                    Sekarang</a>
            </form>
        </div>
    </div>
    ...
    <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md">
        ...
        <div class="p-6">
            ...
            <div class="flex justify-center">
                <a href="/levelup/event/{{ $event->id }}"
                    class="inline-flex items-center py-2 px-5 text-lg font-medium text-center text-white bg-[#E84A5F] rounded-lg hover:bg-[#E84A5F]/75 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Detail
                </a>
            </div>
        </div>
