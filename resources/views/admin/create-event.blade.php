...
<div class="flex justify-center item-center mt-8">
    <h1 class="text-2xl font-bold">Form Tambah Data Event</h1>
</div>
<div class="flex justify-center item-center">
    <form method="POST" action="/event" class="w-6/12" enctype="multipart/form-data">
        @csrf
                    ...
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                                <input type="text" class="p-1 px-2 w-96" id="nama" name="nama" value="{{ old('nama')}}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                                <input type="text" class="p-1 px-2 py-10 w-96" id="link_conference"
                                    name="link_conference" value="{{ old('link_conference')}}">
                            </div>
                        </div>
                    </div>
                </div>
