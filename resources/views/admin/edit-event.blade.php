...
<div class="flex justify-center item-center mt-8">
    <h1 class="text-2xl font-bold">Form Edit Data Event</h1>
</div>
<div class="flex justify-center item-center">
    <form method="POST" action="/event/{{ $event->id }}" class="w-6/12" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="bg-abu rounded-lg">
            <div class="m-10 py-10">
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    <div class="w-44 font-bold h-6 mx-2 mt-3">Nama Event</div>
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                                <input type="text" class="p-1 px-2 w-96" id="nama" name="nama" value="{{ old('nama',  $event->nama) }}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    <div class="w-44 font-bold h-6 mx-2 mt-3">Harga Tiket</div>
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    ...
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                                <input type="text" class="p-1 px-2 py-10 w-96" id="deskripsi" name="deskripsi"
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    <div class="w-44 font-bold h-6 mx-2 mt-3">Tanggal Event</div>
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                ...
                <div class="flex flex-col md:flex-row pb-4 mb-4">
                    <div class="w-44 font-bold h-6 mx-2 mt-3">Link Acara</div>
                    <div>
                        <div class="flex flex-col md:flex-row w-max">
                            <div class="flex-1 my-2 p-1 bg-white flex border border-gray-200 rounded-lg">
                                <input type="text" class="p-1 px-2 py-10 w-96" id="link_conference"
                                    name="link_conference" value="{{ old('link_conference',  $event->link_conference) }}">
                            </div>
                        </div>
                    </div>
                </div>
